    ...
    <div>
      ...
      >
        <div className="flex gap-2">
          ...
          <Button variant="secondary" onClick={() => navigate('/presupuesto-hibrido')}>
            <span className="flex items-center gap-2">
              <Camera className="w-4 h-4" /> Flujo híbrido
            </span>
          </Button>
        </div>
      </PageHeader>
                    ...
                    <div className="flex flex-wrap items-center gap-2 sm:justify-end">
                      ...
                      <button
                        onClick={async (e) => {
                          ...
                          const message = `Hola ${c?.nombre || ''}, le informamos que su presupuesto ${p.numero} para el vehículo ${matricula} está disponible por un importe de ${p.total.toFixed(2)}€. Adjunto el PDF del presupuesto. Puede contactarnos para cualquier duda. Saludos, DM CAR`;
